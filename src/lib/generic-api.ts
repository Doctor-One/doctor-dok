...
export async function authorizeDownloadRequestContext(request: NextRequest): Promise<AuthorizedRequestContext> {
    ...
    if (jwtToken) {
        ...
        if(!authResult) {
            ...
            return {
                ...
                serverCommunicationKey: decoded.payload.serverCommunicationKey as string // OTP key generated by the server
            }
        }
    } else {
