      ...
      <div className="border-2 border-dashed border-green-400 p-5">
        ...
        <div className="flex gap-2 mt-5">
          <Button variant="outline" className="p-1 h-10 p-2" onClick={async (e) => {
            ...
            link.href = url;
            link.download = 'database-key.pdf';
            link.target = '_blank';
      ...
      <form onSubmit={handleCreateDatabase}>
        ...
        <div className="text-sm justify-between gap-4 mt-4">
          ...
          <Label htmlFor="acceptTerms">
            I hereby accept Doctor Dok <Link target="_blank" className="underline hover:text-blue-500" href={termsUrl}>Terms of Service</Link> and <Link target="_blank"  className="underline hover:text-blue-500" href={privacyUrl}>Privacy Policy</Link>.
          </Label>
